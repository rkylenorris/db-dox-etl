...
from .query_model import Queries


class SourceDatabase:

    def __init__(self, db_name: str, settings: AppSettings = get_app_settings(), metadata_queries: Queries = Queries()):
        self.name = db_name
        self.settings = settings
        self.db_config = settings.get_source_db_by_name(db_name)
        self.engine: Engine = self._create_engine()
        self._queries: Queries = metadata_queries
